...
CATEGORIAS = [
    ...
    {"nome": "Investimentos",   "icone": "chart.svg",   "cor": "#F39C12", "tipo": "RECEITA"},
    {"nome": "Reembolso",       "icone": "refresh.svg", "cor": "#1ABC9C", "tipo": "RECEITA"},
    {"nome": "Vale Refeição",   "icone": "food2.svg",   "cor": "#E67E22", "tipo": "RECEITA"},
    {"nome": "Vale Transporte", "icone": "bus.svg",     "cor": "#9B59B6", "tipo": "RECEITA"},
]
...
def seed(conn: psycopg2.extensions.connection) -> None:
    ...
    """, (
        ...
        USUARIO["email"], USUARIO["senha"], USUARIO["tel"], USUARIO["ativo"],
    ))
    conn.commit()
    ...
    while len(transacoes) < 120:
        descricao, vmin, vmax, tipo, cat_idx, recorrencia, parcelado = random.choice(TRANSACOES_TEMPLATE)
        ...
        transacoes.append((
            valor, tipo, descricao, data_tx,
            parcelado, recorrencia, fim_tx,
            inst_id, cat_id,
        ))
